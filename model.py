        ...
        try:
            ...
            with sv.VideoSink(target_video_path, video_info) as sink:
                ...
                for frame in frame_generator:
                    ...
                    for tid, [_, y] in zip(detections.tracker_id, points): # Use remapped detections.tracker_id
                    ...
                    # cv2.imshow("frame", annotated_frame) # Commented out to avoid GUI errors
                    # if cv2.waitKey(1) & 0xFF == ord("q"): # Commented out to avoid GUI errors
                    #     break
                # cv2.destroyAllWindows() # Commented out as imshow is removed
